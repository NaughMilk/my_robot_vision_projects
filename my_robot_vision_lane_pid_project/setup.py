...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "gazebo_lane_pid_driver = my_robot_vision.lane_pid_experiment.gazebo_lane_pid_driver:main",
            "gazebo_road_sign_camera_detector = my_robot_vision.lane_pid_experiment.road_sign_camera_detector:main",
            "gazebo_traffic_light_visual_cycle = my_robot_vision.lane_pid_experiment.traffic_light_visual_cycle:main",
        ],
    },
)
